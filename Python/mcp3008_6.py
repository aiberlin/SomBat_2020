...
### button vars
# button addresses: 
buttonAddrs = [ ['1/switch1', '1/trig1'], ['1/toggleM', '1/trig2'], ['1/switch2', '1/trig3'] ]
buttonStates    = [0, 0, 0]
...
1: {
	0: "upper on",
	2: "lower off, upper on",
	3: "lower off"
}, 
2: {
	0: "lower on",
	1: "lower on, upper off",
	3: "upper off"
}, 
3: { 
	0: "both on",
	...
	while True:
		...
		for i in range(3):
			...
			if(buttonStates[i] != buttonStatesOld[i]):
				...
				print("chan: {} state: {} xition {}".format(i, buttonStates[i], statechange))
				buttonStatesOld[i] = buttonStates[i]
				

#			print("state: {} Value {}  chan {}".format(buttonStates[i], readVal, i))
