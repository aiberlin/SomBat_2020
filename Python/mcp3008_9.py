...
# Analog input (MCP3008) to OSC, SomBat_2020, 
# cc HH 2020 - hannes@airborneinstruments.eu
# ver >= 0.7 is deployable
# call like this from SC: 
# unixCmd("python3 /mnt/sombat2020/temp/code/mcp3008/mcp3008_8.py --port %".format(NetAddr.localAddr.port) );
# toDo: send toggle state at beginning for a few times!
...
if __name__ == "__main__":
	print("*** starting Analog input (MCP3008) to OSC, SomBat_2020")
